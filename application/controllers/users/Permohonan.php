...
class permohonan extends User_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'users/data_permohonan/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'users/data_permohonan/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'users/data_permohonan/index.html';
            $config['first_url'] = base_url() . 'users/data_permohonan/index.html';
        }
        ...
        $this->template->load('template_load','users/data_permohonan/data_permohonan_list', $data);
    }
