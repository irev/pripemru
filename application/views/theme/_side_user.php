		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<?php 
					if ($this->uri->segment(2)=='Perusahaan' || $this->uri->segment(2)=='ruang') {
					...
					<!--li class=""-->
						...
						<ul class="submenu">
							<?php 
								if ($this->uri->segment(2)=='Perusahaan') {
								...
								?>
								<!--li class=""-->
								<a href="<?= base_url('users/Perusahaan/') ?>" title="Master Anggaran DPA/DPPA">
							...
							<?php 
								...
								<a href="<?= base_url('users/ruang') ?>" title="Master Kegiatan Anggaran">
									<i class="menu-icon fa fa-caret-right"></i>
									Data Permohonan
								</a>
			...
			<?php 
					if ($this->uri->segment(2)=='permohonan') {
						echo '<li class="active open">';
					}else{
						echo '<li class="">';
					}
			?>
					...
					<!--li class=""-->
						...
						<ul class="submenu">
								...
								?>
								<!--li class=""-->
								<a href="<?= base_url('users/permohonan/') ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Daftar Permohonan
								</a>
