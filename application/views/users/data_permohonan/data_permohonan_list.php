   <script type="text/javascript">
    function syarat($data={},$no){
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('users/permohonan/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('users/permohonan/index'); ?>" class="form-inline" method="get">
        ...
        <table class="table table-bordered" style="margin-bottom: 10px">
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('users/permohonan/read/'.$data_permohonan->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('users/permohonan/update_validasi/'.$data_permohonan->id.'/'. $data_permohonan->RuangID.'/'.$data_permohonan->type),'Update'); 
				echo ' | '; 
				echo anchor(site_url('users/permohonan/delete/'.$data_permohonan->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
            <?php
		...
		<?php echo anchor(site_url('users/permohonan/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
