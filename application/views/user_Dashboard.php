...
<div class="row">
	<div class="alert alert-block alert-success">
									...
									SELAMAT DATANG
									<strong class="green">
										Sistem Informasi Menejemen Permohonan Rekomendasi Izin/informasi TAtaruang (SIMPRITA) DPUPR PASBAR <?= $this->session->userdata("TA") ?>
										<small>(v1.0)</small>
									</strong>, source code tersedia di 
	 <a href="https://github.com/irev/pripemru">github</a> devlop by Meedun. Untuk Petunjuk pemakaian silahkan klik <a href="<?= base_url("about?panduan") ?>">Panduan disisni </a>.
								</div>
...
<div class="row">
	<div class="col-md-12">
		<h3 class="header smaller lighter blue"><i class="fa fa-list"></i> PERMOHONAN REKOMENDASI <small>Pilih menu dibawah ini.</small> </h3>
		<a href="<?= base_url("ruang/index?q=izin") ?>" class="btn btn-app btn-success " style="width: 45% !important">
			<i class="ace-icon fa fa-map bigger-230"></i> <i class="ace-icon glyphicon  glyphicon-check bigger-230"></i>
				<small>IZIN</small>
			<!--span class="badge badge-warning badge-left">12</span-->
		</a>
		<a href="<?= base_url("ruang/index?q=informasi") ?>" class="btn btn-app btn-danger " style="width: 45% !important">
...
<div class="row">
	<div class="col-md-12">
		...
		<a href="<?= base_url("m_syarat") ?>" class="btn btn-app btn-primary " style="width: 150px !important">
