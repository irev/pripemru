		...
		<th>Action</th>
			...
			<td><a href="<?= base_url('perusahaan/read/'.$ruang->peruID) ?>"><?php echo $this->Perusahaan_model->get_data_by($ruang->peruID, 'nmPeru') ?></a></td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('ruang/read/'.$ruang->idRuang),'Read'); 
				echo ' | '; 
		...
		<?php echo anchor(site_url('ruang/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
